...
while True:  #Asking for input on Location to be searched
    address = input('Enter location to be searched: ')
    if len(address) < 1:
        break
    ...
    if not js or 'status' not in js or js['status'] != 'OK':
        ...
        print('data as folows',data)
        continue

    print ('dump here:',json.dumps(js,indent=4))
